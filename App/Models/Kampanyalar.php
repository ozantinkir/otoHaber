 ...
 */
class Kampanyalar extends \Core\Model
{
    ...
    public function show() {
        $result = ($this->pdo)->select('kampanyalar')
                              ->orderBy('id', 'asc')
